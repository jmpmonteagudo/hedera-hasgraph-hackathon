...
public final class HelloFuture_SmartContractDeploy {
	...
	public static void main(String... arguments) {
		...
		account = AccountCreate.create(account, newAccountKey, 100 * 1000000 * 5000 / 10000);
		...
		if (account != null) {
			...
			try {
				...
				contract = ContractCreate.create(contract, fileId, 0);
